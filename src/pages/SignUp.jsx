    ...
    <section>
      ...
      <div className="flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto">
        <div className="md:w-[67%] lg:w-[50%] mb:12 md:mb-6">
          <img src="https://images.unsplash.com/photo-1553991562-9f24b119ff51?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=3139&q=80" alt="key" className='w-full rounded-2xl' />
        </div>
        <div className="w-full md:w-[67%] lg:w-[40%] ml-20">
          <form action="" className='' onSubmit={onSubmit}>
            <input type="text" className="mb-6 w-full px-4 py-2 text-xl text-gray-700 bg-white border-gray-300 rounded transition ease-in-out" id='name' value={name} onChange={onChange} placeholder='Full name'/>
            ...
            <div className="flex justify-between whitespace-nowrap text-sm sm:text-lg">
              ...
              <Link className='text-red-600 hover:text-red-700 transition duration-200 ease-in-out ml-1' to="/sign-in">Sign in</Link></p>
              <p><Link className='text-blue-600 hover:text-blue-700 transition duration-200 ease-in-out ml-1' to="/forgot-password">Forgot-password?</Link></p>
            </div>
